...
proc igInputScalarN*(label: cstring, data_type: ImGuiDataType, v: pointer, components: int32, step: pointer = nil, step_fast: pointer = nil, format: cstring = nil, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputScalarN".}
...
proc renderChar*(self: ptr ImFont, draw_list: ptr ImDrawList, size: float32, pos: ImVec2, col: ImU32, c: ImWchar): void {.imgui_lib, importc: "ImFont_RenderChar", varargs.}
...
proc clearFonts*(self: ptr ImFontAtlas): void {.imgui_lib, importc: "ImFontAtlas_ClearFonts", varargs.}
...
proc igInputInt2*(label: cstring, v: ptr int, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputInt2", varargs.}
...
proc addQuad*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2, d: ImVec2, col: ImU32, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_AddQuad", varargs.}
...
proc getVoidPtrRef*(self: ptr ImGuiStorage, key: ImGuiID, default_val: pointer = nil): ptr pointer {.imgui_lib, importc: "ImGuiStorage_GetVoidPtrRef", varargs.}
